...
public final class GameServer {
    ...
    */
    public GameServer(File entitiesFile, File actionsFile) throws ParserConfigurationException {
        this.gameStateAccessor = new GameStateAccessor();
        GameEntityParser entityParser = new GameEntityParser(entitiesFile, this.gameStateAccessor);
    ...
    */
    public String handleCommand(String command) {
        CommandHandler commandHandler = new CommandHandler(command, this.gameStateAccessor);
